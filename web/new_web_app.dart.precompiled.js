...
w=P.at()
$.Dz=w
this.e.wR(["spawned",new H.JM(w.vl,$globalState.N0.jO)])
...
static:{K1:function(a,b,c,d){var z=new H.xy(a,b)
H.VM(z,[c,d])
return z}}},
xy:{
"":"i1;Kw,ew",
...
static:{"":"ry,bG,Q9,Ir,na,lk,JA,N3,bs"}},
qB:{
"":"Tp;a",
call$0:function(){var z,y
z=this.a
...
aN:function(a,b){var z,y,x,w
z=this.gB(a)
for(y=a.length,x=z!==y,w=0;w<z;++w){if(w>=y)throw H.e(a,w)
b.call$1(a[w])
...
$asMO:null}}],["dart.isolate","dart:isolate",,P,{
...
return}throw "Unable to print message: " + String(a)}}],["","new_web_app.dart",,N,{
...
y.vM=y.vM+w}document.querySelector("#sample_text_id").textContent=y.vM}},1],])
...
init.globalFunctions.EB=N.EB=new P.vE(N.qd,"EB")
J.im.$isint=true
J.im.$isa=true
J.O.$isString=true
J.O.$isa=true

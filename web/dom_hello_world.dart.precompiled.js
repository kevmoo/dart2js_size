...
if($desc instanceof Array)$desc=$desc[1]
Pz.prototype=$desc
return[qE,Gh,fY,Mr,lJ,ct,rZ,QP,IF,Ny,d7,HA,vH,xO,rV,Wy,QF,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,Yu,iG,mK,xf,Vb,ST,tb,pA,Mi,tt,wP,eP,AL,Og,M6,El,mC,SV,ZY,Ee,Qb,xI,FO,KV,VS,G7,l9,Ql,wL,SN,HD,p3,qj,KR,fs,j2,lp,kd,yN,Cp,zD,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,FH,RH,lz,vw,aG,r0,nK,yp,c1,Mq,Nf,Nc,Y0,ZJ,mU,eZ,IT,ui,VL,DQ,Sm,xL,es,jw,lv,pf,py,Ef,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,yu,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,tp,rE,PI,PQ,uz,NB,NO,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,EU,d5,hy,r8,aS,CG,mH,jk,Rk,Eo,Pe,UM,ZD,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,Qm,FK,Gv,yE,CD,Ue,iC,is,Q,nM,tN,Jt,P,im,VA,O,dr,TL,KX,uZ,OQ,Tp,dC,wN,VX,a7,Ge,LK,AT,bJ,ds,UV,t7,HG,c8,a,Rn,yh,Pz]}